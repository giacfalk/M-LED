...
processing.run("qgis:zonalstatistics",
               {'INPUT_RASTER': population, 'RASTER_BAND': 1, 'INPUT_VECTOR': clusters,
                'COLUMN_PREFIX': 'pop', 'STATISTICS': [1]}, feedback=f)

# Add noaccess
processing.run("qgis:zonalstatistics",
               {'INPUT_RASTER': popnoaccess2018, 'RASTER_BAND': 1, 'INPUT_VECTOR': clusters,
                'COLUMN_PREFIX': 'noacc', 'STATISTICS': [1]}, feedback=f)
...
processing.run("qgis:zonalstatistics", {'INPUT_RASTER': cropland_extent_reprojected, 'RASTER_BAND': 1, 'INPUT_VECTOR': clusters, 'COLUMN_PREFIX': 'cr_ha_', 'STATISTICS': [0]})
...
processing.run("qgis:zonalstatistics", {'INPUT_RASTER': ID_raster, 'RASTER_BAND': 1, 'INPUT_VECTOR': clusters, 'COLUMN_PREFIX': 'id_pix_ras_', 'STATISTICS': [9]})
...
for X in files:
    ...
    processing.run("qgis:zonalstatistics",
                   {'INPUT_RASTER': X, 'RASTER_BAND': 1, 'INPUT_VECTOR': clusters,
                    'COLUMN_PREFIX': a, 'STATISTICS': [1]}, feedback=f)
...
processing.run("qgis:zonalstatistics", {'INPUT_RASTER': climatezones, 'RASTER_BAND': 1, 'INPUT_VECTOR': clusters, 'COLUMN_PREFIX': 'clima_zone', 'STATISTICS': [9]})
...
for X in list_months:
    ...
    processing.run("qgis:zonalstatistics",
                   {'INPUT_RASTER': pet, 'RASTER_BAND': bandnum, 'INPUT_VECTOR': clusters,
                    'COLUMN_PREFIX': "PET_" + X, 'STATISTICS': [2]})
    bandnum = bandnum + 1
    print(bandnum)
...
for X in list_months:
    print(X)
    processing.run("qgis:zonalstatistics", {'INPUT_RASTER': ppt, 'RASTER_BAND': bandnum, 'INPUT_VECTOR': clusters, 'COLUMN_PREFIX': "PPT_" + X, 'STATISTICS': [2]})
    bandnum = bandnum + 1
...
for X in list_months:
    print(X)
    processing.run("qgis:zonalstatistics", {'INPUT_RASTER': soil, 'RASTER_BAND': bandnum, 'INPUT_VECTOR': clusters, 'COLUMN_PREFIX': "SOI_" + X, 'STATISTICS': [2]})
    bandnum = bandnum + 1
...
clusters = clusters[fields_to_copy]
...
processing.run('gdal:warpreproject', {'INPUT' : categories_surface_water, 'TARGET_CRS': 'EPSG:3395', 'OUTPUT' : processed_folder + 'transitions_wm.tif'})
...
processing.run("qgis:zonalstatistics", {'INPUT_RASTER': distance_surfwater, 'RASTER_BAND': 1, 'INPUT_VECTOR': clusters, 'COLUMN_PREFIX': 'surfw_dist_', 'STATISTICS': [2]})
...
# Zonal statistics
processing.run("qgis:zonalstatistics", {'INPUT_RASTER': groundwater_depth, 'RASTER_BAND': 1, 'INPUT_VECTOR': clusters, 'COLUMN_PREFIX': 'gr_wat_depth_', 'STATISTICS': [2]})
...
# Zonal statistics
processing.run("qgis:zonalstatistics", {'INPUT_RASTER': groundwater_storage, 'RASTER_BAND': 1, 'INPUT_VECTOR': clusters, 'COLUMN_PREFIX': 'gr_wat_storage_', 'STATISTICS': [2]})
...
# Zonal statistics
processing.run("qgis:zonalstatistics", {'INPUT_RASTER': groundwater_productivity, 'RASTER_BAND': 1, 'INPUT_VECTOR': clusters, 'COLUMN_PREFIX': 'gr_wat_productivity_', 'STATISTICS': [2]})
...
processing.run("qgis:zonalstatistics",
               {'INPUT_RASTER': input_folder + 'GHSL_settlement_type.tif', 'RASTER_BAND': 1, 'INPUT_VECTOR': clusters,
                'COLUMN_PREFIX': 'isurban', 'STATISTICS': [9]})
...
#clusters = QgsVectorLayer(db_folder + '/statcompiler_subnational_data_2020-03-17/shps/sdr_subnational_data_dhs_2015.shp',"","ogr") 
#
#raster_tiers = QgsRasterLayer('D:/merged_tiers.tif')
#
#processing.run("qgis:zonalstatistics",
#               {'INPUT_RASTER': raster_tiers, 'RASTER_BAND': 1, 'INPUT_VECTOR': clusters,
#                'COLUMN_PREFIX': 'acc_pop_t1', 'STATISTICS': [1]})
#
#processing.run("qgis:zonalstatistics",
#               {'INPUT_RASTER': raster_tiers, 'RASTER_BAND': 2, 'INPUT_VECTOR': clusters,
#                'COLUMN_PREFIX': 'acc_pop_t2', 'STATISTICS': [1]})
#
#processing.run("qgis:zonalstatistics",
#               {'INPUT_RASTER': raster_tiers, 'RASTER_BAND': 3, 'INPUT_VECTOR': clusters,
#                'COLUMN_PREFIX': 'acc_pop_t3', 'STATISTICS': [1]})
#
#processing.run("qgis:zonalstatistics",
#               {'INPUT_RASTER': raster_tiers, 'RASTER_BAND': 4, 'INPUT_VECTOR': clusters,
#                'COLUMN_PREFIX': 'acc_pop_t4', 'STATISTICS': [1]})
#
#population = QgsRasterLayer(input_folder + 'landscan2017.tif')
#
## print(f"Add population to clusters. Elapsed time:", round((time.time() - then) / 60, 2), " minutes")
#processing.run("qgis:zonalstatistics",
#               {'INPUT_RASTER': population, 'RASTER_BAND': 1, 'INPUT_VECTOR': clusters,
...
dhs = QgsVectorLayer(db_folder + '/statcompiler_subnational_data_2020-03-17/shps/sdr_subnational_data_dhs_2015.shp',"","ogr") 
...
#Write to file
processing.run("native:joinattributestable", {
        'INPUT': processed_folder + 'clusters_final_0102.gpkg', 'FIELD': 'id',
