...
Di_print = Dispensary.Appliance(Dispensary,1,40,1,60,0.2,30, wd_we_type = 0)
...
Di_heater = Dispensary.Appliance(Dispensary,1,1500,1,180,0.2,30, wd_we_type = 0)
Di_heater.windows([480,1020],[0,0],0.2)

Di_phones = Dispensary.Appliance(Dispensary,6,4,1,300,0.2,60, wd_we_type = 0)
