...
SCH_indoor_bulb.windows([0,1440],[0,0],0.35)

SCH_indoor_tubes = SCHospital.Appliance(SCHospital, 60,30,1,960,0.2,720)
SCH_indoor_tubes.windows([0,1440],[0,0],0.35)
...
SCH_dental = SCHospital.Appliance(SCHospital,1,550,1,300,0.2,180, occasional_use = 0.7)
...
SCH_incubator = SCHospital.Appliance(SCHospital,10,300,1,1440,0.3,1080)
...
SCH_print = SCHospital.Appliance(SCHospital,2,40,1,300,0.2,120)
...
SCH_photocopy = SCHospital.Appliance(SCHospital,2,400,1,300,0.2,120)
...
SCH_heater = SCHospital.Appliance(SCHospital,10,1500,1,600,0.2,480, occasional_use = 0.85)
SCH_heater.windows([0,1440],[0,0],0.2)

SCH_elheater = SCHospital.Appliance(SCHospital,2,1200,1,60,0.2,15)
SCH_elheater.windows([0,1440],[0,0],0.2)
...
SCH_nebulizer.windows([0,1440],[0,0],0.2)

SCH_Xray = SCHospital.Appliance(SCHospital,2,32000,1,90,0.2,30, occasional_use = 0.70)
...
SCH_phones = SCHospital.Appliance(SCHospital,50,4,1,600,0.2,420)
SCH_phones.windows([0,1440],[0,0],0.35)
...
SCH_HVAC = SCHospital.Appliance(SCHospital,1,12000,1,1440,0,30, 'yes',3)
SCH_HVAC.windows([0,1440],[0,0])
SCH_HVAC.specific_cycle_1(250,20,5,10)
SCH_HVAC.specific_cycle_2(250,15,5,15)
SCH_HVAC.specific_cycle_3(250,10,5,20)
SCH_HVAC.cycle_behaviour([580,1200],[0,0],[420,579],[0,0],[0,419],[1201,1440])
