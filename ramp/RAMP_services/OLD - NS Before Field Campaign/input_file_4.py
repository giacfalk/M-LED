...
S_indoor_tubes = School.Appliance(School,129,30,2,360,0.2,120,wd_we_type = 0)
...
S_Phone_charger = School.Appliance(School,14,4,2,300,0.2,60,wd_we_type = 0)
S_Phone_charger.windows([480,720],[840,1020],0.35)

S_PC = School.Appliance(School,51,100,2,180,0.2,120, occasional_use = 0.7,wd_we_type = 0)
...
S_laptop = School.Appliance(School,10,24,1,240,0.2,120,wd_we_type = 0)
S_laptop.windows([480,990],[0,0],0.2)

S_printer = School.Appliance(School,1,40,2,90,0.2,60,wd_we_type = 0)
S_printer.windows([600,720],[840,1020],0.35)

S_photocopy = School.Appliance(School,1,400,2,90,0.2,60,wd_we_type = 0)
...
S_heater = School.Appliance(School,2,1200,1,30,0.3,10,wd_we_type = 0)
