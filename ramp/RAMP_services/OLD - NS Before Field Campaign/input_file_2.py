...
HC_xray = Healthcenter.Appliance(Healthcenter,1,32000,1,30,0.2,10, occasional_use = 0.5)
...
HC_print = Healthcenter.Appliance(Healthcenter,2,40,1,120,0.2,60)
...
HC_heater = Healthcenter.Appliance(Healthcenter,4,1500,1,480,0.2,300, occasional_use = 0.6)
HC_heater.windows([0,1440],[0,0],0.2)

HC_phones = Healthcenter.Appliance(Healthcenter,20,4,1,300,0.2,60)
